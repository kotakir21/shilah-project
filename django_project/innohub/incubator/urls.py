...
urlpatterns = [
    ...
    path('engineer-active-incubators/', views.engineer_active_incubators, name='engineer-active-incubators'),  # Updated view and URL
    path('engineer-resolved-incubators/', views.engineer_resolved_incubators, name='engineer-resolved-incubators'),  # Updated view and URL
