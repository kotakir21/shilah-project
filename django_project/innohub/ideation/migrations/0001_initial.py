# Generated by Django 4.2.9 on 2024-01-17 18:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('serving_sectors', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ideations_customer', to=settings.AUTH_USER_MODEL)),
                ('engineer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='ideations_engineer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
